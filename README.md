...
- **Alzheimer’s Disease Detection (GNN + MRI)**  
  End-to-end pipeline on AWS (S3, EC2, SageMaker).  
- **YOLO / MobileNet Implementations**  
  Modular training + inference with clean preprocessing design.  
- **FPGA Image Processing**  
  Hardware-accelerated filtering and feature extraction.
